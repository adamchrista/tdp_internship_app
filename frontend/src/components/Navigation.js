    ...
    render(){
        ...
        <div className="h-20 w-full items-center px-8 bg-blue-400 text-black-800 flex justify-between">
            ...
            <div className="flex ml-6 font-medium text-lg flex-1 items-start">
                <a href={"/home/"+url} className="ml-4 px-3 py-2 hover:bg-gray-100 rounded-md">Home</a>
                <a href={"/profile/"+url} className="ml-4 px-3 py-2 hover:bg-gray-100 rounded-md">Profile</a>
